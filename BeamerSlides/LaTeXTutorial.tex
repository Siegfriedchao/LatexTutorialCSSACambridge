...
\begin{frame}
	...
	Note that the TeX Live distribution contains yearly updates, and the update installation must be done manually. TeX Live 2019 is scheduled to release by the end of this April.
...
\frametitle{Editors}
	...
	\begin{itemize}
		\item TeXStudio (one that I use to build the beamer slides)
		\item TeXShop
...
\begin{frame}
	...
	We have to remind you that learning \LaTeX \ \emph{ (might be) very hard  \footnotemark}
...
\begin{frame}
	...
	I will demonstrate some useful \LaTeX\xspace templates. 
...
Hopefully, hopefully and hopefully I will be able to answer your questions, because \LaTeX\xspace is HARD.
