...
\begin{frame}
	...
	In the mid 1970s, Donald Knuth, a Stanford CS geek developed \TeX \ in SAIL to typeset his "The Art of Computer Programming" (TAOCP). First public release in 1978. He reimplemented it in Pascal in the mid 80s (WEB, literate programming).  Leslie Lamport, the genius, wrote \LaTeX \ in early 80s by porting the orginal \TeX. 
	
	\bigskip
	
	What is the relationship between \TeX \xspace and \LaTeX? \LaTeX \ uses the \TeX \ typesetting programme to compile and generate its output. \LaTeX \ focuses on the content while \TeX \ is the main programme for setting up the layout.
...
\begin{frame}
\frametitle{What \LaTeX \ can do and what it cannot}

	\begin{itemize}
		\item Write scientific papers
		\item Write theses
		\item Typesetting books and publications
		\item Write typeset letters
		\item Play around with mathematical formula
...
\begin{frame}
	...
	Since \LaTeX \ is a package implemented in the \TeX \ typesetting \textbf{language}, we should consider the \TeX \ input syntax when use it.
...
\begin{frame}
	...
	\begin{itemize}
		\item The effect of typing multiple space is the same as one space.
		\item The effect of typing multiple line feeds is the same as one line break.
		\item If you don't know how and when to use $\backslash$ (backslash), then you are doomed.
...
\begin{frame}[containsverbatim]
	...
	You may either use (1) commands or (2) lexical declarations. \textit{\footnotesize Contents are referenced from the slides for a course held at the Computer Lab, Cambridge.}
	\begin{columns}
		\column{0.2\textwidth}
		\raggedleft
			\begin{verbatim}
...
\begin{frame}
	\frametitle{Useful resources revisit}
	
	\begin{itemize}
		\item University of Cambridge CUED thesis template, \textbf{\href{https://gitlab.com/Siegfriedchao/latextutorial}{Gitlab: Siegfriedchao}}, 
		modified from \textbf{\href{https://github.com/kks32/phd-thesis-template}{Github: kks32}}
		\item University of Cambridge Powerpoint template, \textbf{\href{https://gitlab.com/Siegfriedchao/latextutorial}{Gitlab: Siegfriedchao}}, 
		modified from \textbf{\href{https://github.com/rjw57/cambridge-beamer}{Github: rjw57}}
	\end{itemize}
