...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Powerful, lots and lots of funcationalities for you to discover and extend. Be it theses, papers, slides (using Beamer), spreadsheets... Your imagination is the only limitation (apart from time...).
...
\begin{frame}
	...
	\LaTeX, unlike Microsoft Office Word, is not \textbf{WYSIWYG} (what you see is what you get), and it allows the user to focus on the content and structure of the text. Lots of strange syntax and commands are present in the \LaTeX \ source file. 
...
\begin{frame}
	...
	First and foremost, the pronunciation of \LaTeX. According to the father of \TeX\footnote{This frame here uses the \textit{aquote} package}:
...
\frametitle{How to pronounce \LaTeX\ ?}
	...
	Another quote from the father of \LaTeX\footnote{This frame here uses the \textit{aquote} package}:
...
\begin{frame}
	...
	We have to remind you that learning \LaTeX \ is \emph{(or might be) very hard  \footnotemark}
...
\begin{frame}
	...
	\footnotetext{These arrows are plotted using a package called \textit{tikz}}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Being able to use style files and packages/environments properly is the key to success. Use Google when uncertain.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item The effect of typing multiple line feeds is the same as a one-line break.
...
\begin{frame}
	...
	\Huge{If you do not put theory into practice, you shall never be able to master \LaTeX.}\footnote{An infamous quote from Youchao Wang}
...
\end{document}
		...
		\end{minipage}
			...
			\begin{minipage}{0.98\textwidth}
				\begin{figure}
					\frame{\includegraphics[page = 1, width=0.8\textwidth]{CodeSnippets/StartingAReport.pdf}}
				\end{figure}
			\end{minipage}
\end{columns}
...
This is a sub sub section. Replace text here when you write your report.
		...
		\begin{minipage}{0.98\textwidth}
			\begin{figure}
				\frame{\includegraphics[page = 2, width=0.8\linewidth]{CodeSnippets/StartingAReport.pdf}}
			\end{figure}
		\end{minipage}
\end{columns}
\end{frame}
...
\renewcommand{\footrulewidth}{1pt}
		...
		\begin{minipage}{0.98\textwidth}
			\begin{figure}
				\frame{\includegraphics[page = 3, width = 0.8\linewidth]{CodeSnippets/CodeSnippets1.pdf}}
			\end{figure}
		\end{minipage}
	\end{columns}
\end{frame}
...
\begin{itemize}
	...
	\begin{enumerate}
		% Numberd lists
		\item \lipsum[1]
		% Just trying to make the PDF look okay for this presentation
		\item \lipsum[2]
	\end{enumerate}
\end{itemize}
			\end{lstlisting}
		...
		\begin{minipage}{0.98\textwidth}
			\begin{figure}
				\frame{\includegraphics[page = 4, width = 0.8\linewidth]{CodeSnippets/CodeSnippets1.pdf}}
			\end{figure}
		\end{minipage}
	\end{columns}
\end{frame}
...
Figure~\ref{fig}. Table~\ref{tab}.
		...
		\begin{minipage}{0.98\textwidth}
			\begin{figure}
				\frame{\includegraphics[page = 5, width = 0.8\linewidth]{CodeSnippets/CodeSnippets1}}
			\end{figure}
		\end{minipage}
	\end{columns}
\end{frame}
...
\end{equation}
	...
	\centering
		\begin{minipage}{0.98\textwidth}
			\begin{figure}
				\frame{\includegraphics[page = 6, width = 0.8\linewidth]{CodeSnippets/CodeSnippets1.pdf}}
			\end{figure}
...
use google
	...
	\begin{minipage}{0.98\textwidth}
		\begin{figure}
			\frame{\includegraphics[page = 7, width = 0.8\linewidth]{CodeSnippets/CodeSnippets1.pdf}}
		\end{figure}
	\end{minipage}
	\end{columns}
\end{frame}
...
\begin{frame}
	\frametitle{References: a word of caution}

	\begin{itemize}
		\item I am personally an old user who prefers to use \textit{bibtex} instead of \textit{biblatex}, simply because: (a) most of my bibliography data-base in built upon \textit{bibtex}, (b) I am \textbf{too lazy} to switch.
		\item However, if you have just began to use \LaTeX, do practice your use of \textit{biblatex} as it has a rather more modern implementation.
		\item In fact, for \textit{bibtex} you would use \textit{BibTeX} as your bibliography tool. Unfortunately, this tool does not support \textit{biblatex}, as it uses \textit{Biber}.
	\end{itemize}
...
\end{figure}
		...
		\begin{minipage}{0.98\textwidth}
			\begin{figure}
				\frame{\includegraphics[page = 9, width = 0.8\linewidth]{CodeSnippets/CodeSnippets1}}
			\end{figure}
		\end{minipage}
	\end{columns}
\end{frame}
...
\section{Introduction} 
		...
		\begin{minipage}{0.98\textwidth}
			\begin{figure}
				\frame{\includegraphics[page = 2, width = 0.8\linewidth]{CodeSnippets/CodeSnippets1}}
			\end{figure}
		\end{minipage}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	I will demonstrate some useful \LaTeX\xspace templates, in particular those in Overleaf, as it has became way too popular these days given most people are lazy and not bothered setting up their own development environments. 
...
Hopefully, hopefully and hopefully I will be able to answer your questions with my limited years of experience, because \LaTeX\xspace is HARD.
