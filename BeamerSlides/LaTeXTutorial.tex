...
\begin{itemize}
	\item This is our first item
	\item This is our second item and I am making it longer so that you can see how text wraps around automatically in \LaTeX
	\begin{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\item I am personally an old user who prefers to use \textit{bibtex} instead of \textit{biblatex}, simply because: (a) most of my bibliography database is built upon \textit{bibtex}, (b) I am \textbf{too lazy} to switch.
...
\begin{frame}
  ...
  We've mostly looked at \LaTeX{} commands useful
  for {\bf engineers}.

  \LaTeX{} also has packages for linguists,
  musicians, chemists \& other disciplines.

  It's worth checking what \LaTeX{} packages are
  available for your subject!
\end{frame}

\begin{frame}
\frametitle{The last session: Q and A}

Hopefully, hopefully and hopefully I will be able to answer your questions with my limited years of experience, because \LaTeX\xspace is \textsc{hard}.
